    ...
    >
      ...
      <span class="row-copy">
        ...
        <span class="row-flags">
          ...
          <span v-if="deviceDisplay(row).tone!=='no'" :class="{'device-locked':deviceDisplay(row).tone==='locked'}"><Laptop2 aria-hidden="true" />{{ deviceDisplay(row).tone==='locked'?'Thiết bị đang bị khóa':'Thiết bị điện tử' }}</span>
