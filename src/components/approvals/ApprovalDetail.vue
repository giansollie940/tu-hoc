...
import { deviceDisplay } from '../../features/registrations/device-policy'
...
const deviceState = computed(() => deviceDisplay(props.registration))
...
<template>
  <article class="approval-detail">
    ...
    <section class="detail-grid">
      ...
      <div class="detail-block"><h3><Laptop2 aria-hidden="true" />Thiết bị điện tử</h3><p :class="{'device-locked':deviceState.tone==='locked'}">{{ deviceState.label }}</p></div>
